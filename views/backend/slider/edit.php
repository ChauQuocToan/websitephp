                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="link" id="link" class="form-control" required required placeholder="VD: Balo chanel"><?= $row['metadesc']; ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="position">position</label>
                                <textarea name="position" id="position" class="form-control" required required placeholder="VD: Balo chanel, Balo LOUIS VUITTON"><?= $row['metakey']; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
