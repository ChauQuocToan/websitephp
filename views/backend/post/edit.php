                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="mb-3">
                                ...
                                <input name="title" value="<?= $row['title']; ?>" id="id" type="text" class="form-control" require placeholder="VD: MÔ HÌNH NHÂN VẬT,VẬT PHẨM NHÂN VẬT ...">
                            </div>
                            <div class="mb-3">
                                <label for="detail">Chi tiết bài viết</label>
                                <textarea name="detail" id="detail" class="form-control" required required placeholder="VD: Balo chanel"><?= $row['detail']; ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="type">Kiểu bài viết</label>
                                <textarea name="type" id="type" class="form-control" required required placeholder="VD: Balo chanel"><?= $row['type']; ?></textarea>
                            </div>
                            <div class="mb-3">
