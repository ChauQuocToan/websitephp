            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <a class="btn btn-sm btn-success" href="index.php?option=orderdetail">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if($row['status']==1):?>
                                        ...
                                        option=orderdetail&cat=status& id=<?=$row['id']?>">
                        ...
                        option=orderdetail&cat=detail& id=<?=$row['id']?>">
                                            <i class="fas fa-eye"></i></a>
                                            <a class=" btn btn-sm btn-primary " href=" index.php?
                        option=orderdetail&cat=edit& id=<?=$row['id']?>">
                                            <i class="fas fa-edit"></i></a>
                                            <a class=" btn btn-sm btn-info " href=" index.php?
                        option=orderdetail&cat=deletel& id=<?=$row['id']?>">
